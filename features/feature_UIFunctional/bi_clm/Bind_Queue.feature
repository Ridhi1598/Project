@ingestion @bindQueue @rmq @postSetup
Feature: Bind request queue to the exchange
  ...
  Scenario: Bind request queue to the default exchange
    Given I set "RMQ" url
    And I set api endpoint "/api/bindings/%2F/e/com.telus.tinaa.bsaf.clm.bi/q/com.telus.tinaa.bsaf.clm.bi.ingestion.request" for "POST"
