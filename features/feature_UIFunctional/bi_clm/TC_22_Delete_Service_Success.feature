...
Feature: Delete an Existing Service
  This feature tests the portal functionality for deleting an existing service with success response
  ...
  Scenario: Delete an Existing Service-Success
    ...
    And Mock "success" response to "RMQ" "tinaa-callbacks-tests" queue
