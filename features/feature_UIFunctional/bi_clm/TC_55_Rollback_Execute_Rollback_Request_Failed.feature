@TC_55
Feature: RollBack - Execute rollback request: Failed
  This feature tests the functionality related to execute the rollback request - Failed

  Scenario: Execute rollback request: Failed
