@TC_72
Feature: RollBack - Execute inprogress request
  This feature tests the functionality related to execute the inprogress request - Success

  Scenario: Execute inprogress request: Success
