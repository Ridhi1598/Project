@ingestion @unbindQueue @rmq @preSetup
Feature: Unbind request queue from the exchange
  ...
  Scenario: Unbind request queue from the default exchange
    Given I set "RMQ" url
    And I set api endpoint "/api/bindings/%2F/e/com.telus.tinaa.bsaf.clm.bi/q/com.telus.tinaa.bsaf.clm.bi.ingestion.request/com.telus.tinaa.bsaf.clm.bi.ingestion.request" for "DELETE"
    ...
    And Validate that "com.telus.tinaa.bsaf.clm.bi.ingestion.request" queue "does not have" "com.telus.tinaa.bsaf.clm.bi" exchange as source