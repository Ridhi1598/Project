Feature: Error Message Will show On click of status button incase of timeout- Work Orders Page

  Scenario: Error message for click on status button- timeout
...
#    Then I go to "WorkOrders" page
    ...
    When I click on "timeout" button
