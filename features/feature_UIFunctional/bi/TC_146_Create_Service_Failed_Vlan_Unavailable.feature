...
Feature: Create a new service
  ...
  Scenario: Create a new service: Failed
    Given I set data values against testcase "146"
    ...
    And Mock "vlan-failed" response to be published to RMQ "tinaa-bi-request-callbacks" queue
    ...
    And Validate the expected "error" message
