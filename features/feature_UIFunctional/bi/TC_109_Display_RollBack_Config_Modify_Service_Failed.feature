Feature: Display RollBack Current and Expected Config
  ...
  Scenario: Display Rollback Current and Expected Config : Failed to fetch Current and Expected config
    Given I set data values against testcase "109"
