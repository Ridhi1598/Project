...
Feature: Activate an existing service
  This feature tests the portal functionality for activating an existing service with failed callback response

  Scenario: Activate an existing service: Failed
    Given I set data values against testcase "5"
