@portal @tc14
Feature: Delete MWR from an existing service
  This feature tests the portal functionality for deleting MWR from an existing MWR service with success response

  Scenario: Delete MWR from an existing MWR service : Success
    Given I set data values against testcase "14"
    ...
    And Validate that "operationType" should be "delete mwr"
    ...
    And Assert that "RollBack" is displayed
