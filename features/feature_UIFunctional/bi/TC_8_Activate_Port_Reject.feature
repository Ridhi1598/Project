...
Feature: Activate an existing service
  This feature tests the portal functionality for activating an existing service which gets rejected

  Scenario: Activate an existing service: Reject
    Given I set data values against testcase "8"
