Feature:Modify Delete MWR Service
  This feature tests the functionality of Modify a delete MWR service and validation

  Scenario: Modify an MWR service and validation
    Given I set data values against testcase "135"
