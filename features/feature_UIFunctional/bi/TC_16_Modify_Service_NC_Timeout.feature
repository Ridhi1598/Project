@portal @tc16
Feature: Modify an existing service
  This feature tests the portal functionality for updating an existing service with success response

  @modifyService
  Scenario: Modify an existing service : Success
    Given I set data values against testcase "16"
