...
Feature: Add MWR to an existing service
  This feature tests the portal functionality for adding MWR to an existing service with failed response

  Scenario: Add MWR to an existing service : Failed
    Given I set data values against testcase "9"
