@portal @tc11
Feature: Add MWR to an existing service
  This feature tests the portal functionality for adding MWR to an existing service with success response

  Scenario: Add MWR to an existing service : Success
    Given I set data values against testcase "11"
