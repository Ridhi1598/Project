...
Feature: Activate an existing service
  This feature tests the portal functionality for activating an existing service with success callback response

  Scenario: Create a new service: Success
    Given I set data values against testcase "7"
