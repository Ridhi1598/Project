...
Feature: Add MWR to an existing service
  This feature tests the portal functionality for adding MWR to an existing service with no callback response

  Scenario: Add MWR to an existing service : Timeout
