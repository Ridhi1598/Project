...
Feature: Modify an existing service
  This feature tests the portal functionality for updating an existing service which gets rejected

  @modifyService
  Scenario: Modify an existing service : Reject
    Given I set data values against testcase "18"
