...
Feature: Delete MWR from an existing service
  This feature tests the portal functionality for deleting MWR from an existing MWR service with no callback response

  Scenario: Delete MWR from an existing MWR service : Timeout
    Given I set data values against testcase "13"
