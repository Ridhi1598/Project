...
Feature: Validate orchestrator response for delete mwr service request
  This features validates orchestrator response for successful delete mwr service request
  ...
  Scenario: Delete Mwr Service request with success response
    ...
    Then "Read" and validate that a "delete" "success_callback" message is published in the "RMQ" "orchestrator-callback" queue
