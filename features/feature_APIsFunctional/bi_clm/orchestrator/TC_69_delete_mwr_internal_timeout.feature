@internalTimeout @TC69
Feature: Validate orchestrator response for delete mwr request
  This features validates orchestrator response for delete mwr request which timed out
