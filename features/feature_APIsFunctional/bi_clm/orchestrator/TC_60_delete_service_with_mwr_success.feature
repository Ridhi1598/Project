...
Feature: Validate orchestrator response for delete service(with mwr) request
  This features validates orchestrator response for successful delete service(with mwr) request
  ...
  Scenario: Delete Service(with mwr) request with success response
