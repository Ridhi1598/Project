@internalTimeout @TC67
Feature: Validate orchestrator response for create service request
  This features validates orchestrator response for create service request which timed out

  Scenario: Create Service request record to rollback secondary evpn profile
