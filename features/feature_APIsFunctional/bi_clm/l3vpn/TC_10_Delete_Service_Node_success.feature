Feature: Validate l3vpn controller's delete operation
  This features validates successful deletion of a service node

  Scenario: Delete a VPN having more than one node. Controller should trigger the ep with node_id param
