Feature: Validate l3vpn controller response for delete MWR Node audit true
  This features tests delete mwr node scenario with audit
  Scenario: Delete MWR Node with audit
