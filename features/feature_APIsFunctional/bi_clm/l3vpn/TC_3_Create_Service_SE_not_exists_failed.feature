Feature: Validate l3vpn controller response for create service request
  This features validates l3vpn controller response for the failed Node creation step at Mediation

  Scenario: Create Service request with failure response from l3vpn controller for the Node creation step at Mediation
