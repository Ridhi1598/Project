Feature: Validate l3vpn controller response for delete Node audit true
  This features tests delete node scenario with audit
  Scenario: Delete Node with audit
