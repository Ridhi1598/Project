Feature: Validate l3vpn controller response for update Node with mwr params
  This features tests update node scenario with mwr parameters
  Scenario: Update Node with MWR parameters
