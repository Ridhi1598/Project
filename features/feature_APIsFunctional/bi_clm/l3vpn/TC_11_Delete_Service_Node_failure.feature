Feature: Validate l3vpn controller's delete operation
  This features validates a failed delete request of a service node

  Scenario: Delete a VPN having more than one node. Controller will trigger the ep with node_id param
