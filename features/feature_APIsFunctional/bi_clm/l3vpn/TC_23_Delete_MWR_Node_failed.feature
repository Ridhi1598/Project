Feature: Validate l3vpn controller response for failure in delete Node with mwr params
  This features tests failure response in delete node with mwr parameters
  Scenario: Delete Node with MWR parameters Failed
