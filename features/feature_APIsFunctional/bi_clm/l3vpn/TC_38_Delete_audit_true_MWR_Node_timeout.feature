Feature: Validate l3vpn controller response for delete MWR Node audit true timeout
  This features tests delete mwr node scenario with audit timeout
  Scenario: Delete MWR Node with audit timeout
