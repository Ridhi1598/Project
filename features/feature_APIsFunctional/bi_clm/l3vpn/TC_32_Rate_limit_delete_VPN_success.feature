Feature: Concurrency Control for Service
  This feature ensures that a VPN service deletion process does not accept another request if
  ...
  Scenario: Testcase for Concurrency Control during Service deletion

    Given I read test data for testcase
    Then I am Adding a in-progress service to L3VPN es-record
