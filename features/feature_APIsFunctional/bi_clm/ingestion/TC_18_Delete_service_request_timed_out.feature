Feature: Validate ingestion response for delete service
  This features validates ingestion response for deleting a service but request times out
  ...
  Scenario: Delete service but the request times out
    ...
    And Execute the "delete" request for processing
    ...
    And I validate that a "service" record is found in "iclm-ingestion-service-services" index
