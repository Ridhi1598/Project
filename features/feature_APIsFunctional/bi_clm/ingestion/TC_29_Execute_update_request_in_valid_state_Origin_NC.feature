@ingestion
Feature: Validate ingestion response for executing a request originating from NC
  This features validates ingestion response for executing a request originating from NC

  Scenario: Executing an update request originating from NC
    ...
    Then I validate that a "node" is "created" in zookeeper instance
