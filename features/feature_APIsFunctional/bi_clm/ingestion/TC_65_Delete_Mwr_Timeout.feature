...
Feature: Validate ingestion response for Delete Mwr Request
  This features validates ingestion response for timed out Mwr Request

  Scenario: Delete Mwr Timeout
    ...
    And I validate the service record for expected "before" "mwr-state" value
    ...
    And I validate the service record for expected "after" "mwr-state" value
