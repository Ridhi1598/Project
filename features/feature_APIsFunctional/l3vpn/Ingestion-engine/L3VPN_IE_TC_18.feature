@IngestionEngine
Feature: Validate IngestionEngine response for delete service failed scenario
  This features validates IngestionEngine response for deleting a failed service request
