@IngestionEngine
Feature: Validate IngestionEngine response for delete service
  This features validates IngestionEngine response for deleting a service successfully

  Scenario: Delete service successfully
    Given I set L3VPN "IngestionEngine" url
    When I set data values against "testCase_20" for Ingestion Engine
