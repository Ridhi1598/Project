@controller @tc6 @updateService
Feature: Validate controller response for update service request
  This features validates controller response for successful update service request
...
# Add step to read befor value of description
  Scenario: update service request with success response from mediation
    Given I set data values against testcase
...
#    Validate that description has changed successfully
