@controller @tc10 @deleteService
Feature: Validate controller response for delete service request
  This features validates controller response for timed out delete service request
  ...
  Scenario: delete service request timeout
    Given I set data values against testcase
