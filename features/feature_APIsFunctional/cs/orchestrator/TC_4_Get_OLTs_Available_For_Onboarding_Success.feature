@tc4 @orchestrator
Feature: Get OLTs that are available for on-boarding
  This feature to get OLTs that are available for on-boarding

   Scenario Outline: Get OLTs that are available for on-boarding
    ...
    |tc_4   |_get_olt_available_for_onboarding_success|_get_olt_available_for_onboarding_l2_to_orchestrator_success|_get_olt_available_for_onboarding_orchestrator_to_portal_success |
