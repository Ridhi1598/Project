@tc22 @orchestrator
Feature: Get BNGs that are available for on-boarding - failed
  This feature to get BNGs that are available for on-boarding

   Scenario Outline: Get BNGs that are available for on-boarding - failed
    ...
    |tc_22   |_get_bng_available_for_onboarding_failed |_get_bng_available_for_onboarding_l2_to_orchestrator_failed  |_get_bng_available_for_onboarding_orchestrator_to_portal_failed  |
