@tc28 @orchestrator
Feature: Lock BNG L2-resources - Failed
  This feature validates that functionality related to Lock the BNG l2-resources

   Scenario Outline: This scenario validate that the functionality related to lock BNG l2-resources- Failed
    ...
    Examples:
     ...
     |tc_28   |_lock_bng_l2_resources_portal_to_orchestrator_failed |_lock_bng_l2_resources_l2_to_orchestrator_failed  |_lock_bng_l2_resources_orchestrator_to_portal_failed|
