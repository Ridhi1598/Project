@tc8 @orchestrator
Feature: Unlock BNG L2-resources - Success
  This feature validates that functionality related to unlock the BNG l2-resources

   Scenario Outline: This scenario validate that the functionality related to unlock BNG l2-resources - Success
    ...
    Examples:
     ...
     |tc_8   |_unlock_bng_l2_resources_portal_to_orchestrator_success |_unlock_bng_l2_resources_l2_to_orchestrator_success |_unlock_bng_l2_resources_orchestrator_to_portal_success|
