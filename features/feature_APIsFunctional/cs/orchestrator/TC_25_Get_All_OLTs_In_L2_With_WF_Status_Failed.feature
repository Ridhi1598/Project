@tc25 @orchestrator
Feature: Get all OLTs in L2 engine with their WF status- Failed
  This feature to get all OLTs in L2 engine with their WF status

   Scenario Outline: Get all OLTs in L2 engine with their WF status - Failed
    ...
    |tc_25   |_get_all_olt_in_l2_with_wf_status_portal_to_orchestrator_failed |_get_all_olt_in_l2_with_wf_status_l2_to_orchestrator_failed |_get_all_olt_in_l2_with_wf_status_orchestrator_to_portal_failed  |
