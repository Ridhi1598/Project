...
Feature: Create the Multicast dry run - failed
  This feature validates that functionality related to create the Multicast dry run
   ...
   Scenario Outline: tc_21: This scenario validate that the functionality related to create the Multicast dry run - failed
    ...
    Examples:
     ...
     |tc_21   | _create_multicast_dry_run_failed  |  _create_multicast_dry_run_bng_to_orchestrator_failed |
