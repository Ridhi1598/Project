@tc38 @bngController
Feature: Delete the L3VPN Service - Success
  This feature validates that functionality related to delete the L3VPN Service - Success

   Scenario Outline: tc_38 : This scenario validate that the functionality related to delete the L3VPN Service - Success
    ...
    Then I validate that the request record should "not exist" in the table "vpn_service" by "vpn_id"
    When I validate that the request record should "not exist" in the table "vpn_node" by "vpn_id"
    ...
    Examples:
     ...
     |tc_38   | _delete_l3vpn_service_success     |  _delete_l3vpn_service_bng_to_portal_success |
