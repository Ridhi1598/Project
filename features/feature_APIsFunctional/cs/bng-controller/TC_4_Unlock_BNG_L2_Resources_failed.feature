...
Feature: Unlock BNG L2-resources
  This feature validates that functionality related to unlock the BNG l2-resources - Failed

   Scenario Outline: tc_4: This scenario validates that the functionality related to unlock BNG l2-resources
    ...
    Examples:
     ...
     |tc_4   | _unlock_bng_l2_resources_failed | _unlock_bng_l2_resources_l2_to_bng_failed | _unlock_bng_l2_resources_bng_to_portal_failed|
