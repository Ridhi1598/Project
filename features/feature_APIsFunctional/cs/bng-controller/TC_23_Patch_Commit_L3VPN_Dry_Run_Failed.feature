@tc23 @bngController
Feature: Create the Multicast commit - failed
  This feature validates that functionality related to create the Multicast commit

   Scenario Outline: tc_23: This scenario validate that the functionality related to create the Multicast commit - failed
    ...
    Examples:
     ...
     |tc_23   | _patch_l3vpn_commit_failed  |  _patch_l3vpn_commit_bng_to_orchestrator_failed |
