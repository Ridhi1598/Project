@apiGateway
Feature: Validate Login Response
  This feature tests the functional test cases related to consumer login API

Background:
  Given I set CS "REST" url
...
@routeFetch
  Scenario: Validate route check for fetching service data
    ...
    And Send "GET" HTTP request
    Then I receive valid HTTP response code "202" for "GET"
