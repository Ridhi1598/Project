@evpn @unbindQueue @rmq @preSetup
Feature: Unbind request queue from the exchange
  This feature unbinds the cs_orchestrator_queue and l2_topology_engine_queue from the exchange before the tests are executed
