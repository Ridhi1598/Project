@orchestrator @tc16 @mwr
Feature: Validate orchestrator response for timed out delete MWR request
  This features validates orchestrator response for timed out delete MWR request
  ...
  Scenario: Timed out delete MWR request
    Given I set data values against testcase
