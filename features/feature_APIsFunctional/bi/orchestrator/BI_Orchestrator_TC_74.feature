@orchestrator @tc74 @updateService
Feature: Validate orchestrator response for deactivating an active service
  This features validates orchestrator response for deactivating an active service
