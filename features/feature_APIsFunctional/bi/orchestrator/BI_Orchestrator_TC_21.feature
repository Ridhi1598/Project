@orchestrator @tc21 @deleteService
Feature: Validate orchestrator response for deleting a VPN successfully
  This features validates orchestrator response for deleting a VPN successfully
  ...
  Scenario: Successful delete VPN request
    Given I set data values against testcase
