@orchestrator @tc19 @deleteService
Feature: Validate orchestrator response for timed out delete service request
  This features validates orchestrator response for timed out delete service request
  ...
  Scenario: Timed Out delete VPN request
    Given I set data values against testcase
