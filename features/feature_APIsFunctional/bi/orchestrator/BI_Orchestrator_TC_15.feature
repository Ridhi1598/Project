@orchestrator @tc15 @mwr
Feature: Validate orchestrator response for failed delete MWR request
  This features validates orchestrator response for failed delete MWR request
  ...
  Scenario: Failed delete MWR request
    Given I set data values against testcase
