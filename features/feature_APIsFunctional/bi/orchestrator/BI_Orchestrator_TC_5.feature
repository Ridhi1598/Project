@orchestrator @tc5 @createService
Feature: Validate orchestrator response for create service request
  This features validates orchestrator response for successful create service under an existing vpn
  ...
  Scenario: Create successful service request
    ...
    And I validate that request "state" is "completed"
