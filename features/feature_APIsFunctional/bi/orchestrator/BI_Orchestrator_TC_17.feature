@orchestrator @tc17 @mwr
Feature: Validate orchestrator response for successful delete MWR request
  This features validates orchestrator response for successful delete MWR request
  ...
  Scenario: Successful delete MWR request
    Given I set data values against testcase
