@orchestrator @tc39 @updateService
Feature: Validate orchestrator response for updating port speed for DSL service
  This features validates orchestrator response for updating port speed for DSL service
  ...
  Scenario: Update invalid speed for DSL service
    ...
    And Validate that the "error" message has correct error code "ERR212"
