@orchestrator @tc136 @createService
Feature: Validate orchestrator response for create GPON service request
  This features validates orchestrator response for failed create service request which fails Vlan Validation

  Scenario: Create GPON Service which fails Vlan Validation: Wildcard returned for outer and inner vlan
