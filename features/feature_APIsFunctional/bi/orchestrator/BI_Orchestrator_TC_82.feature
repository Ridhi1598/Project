@orchestrator @tc82 @updateService
Feature: Validate orchestrator response for updating device name for an existing service
  This features validates orchestrator response for updating device name for an existing service
  ...
  Scenario: Update device name for an existing service
    Given I set data values against testcase
