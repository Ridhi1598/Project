@orchestrator @tc9 @updateService
Feature: Validate orchestrator response for failed port activation request
  This features validates orchestrator response for failed port activation request
  ...
  Scenario: Failed port activation request
    Given I set data values against testcase
