...
Feature: Validate orchestrator response for activating a GPON Service
  This features validates orchestrator response for activating a GPON Service
  ...
  Scenario: Port Activation for GPON Service
    Given I set data values against testcase
