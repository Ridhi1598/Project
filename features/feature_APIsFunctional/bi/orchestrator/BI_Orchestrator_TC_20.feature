@orchestrator @tc20 @deleteService
Feature: Validate orchestrator response for deleting a site successfully
  This features validates orchestrator response for deleting a site successfully
  ...
  Scenario: Successful delete service request
    Given I set data values against testcase
