@orchestrator @tc24 @updateService
Feature: Validate orchestrator response for executing update request with only speed parameter changed
  This features validates orchestrator response for executing update request with only speed parameter changed
