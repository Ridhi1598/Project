@orchestrator @tc22 @updateService
Feature: Validate orchestrator response for executing update request  with multiple parameters origin from TINAA
  This features validates orchestrator response for executing update request with multiple parameters origin from TINAA
  ...
  Scenario: Execute update request with multiple parameters origin from TINAA
    Given I set data values against testcase
