@orchestrator @tc77 @deleteService
Feature: Validate orchestrator response for deleting a non existent service
  This features validates orchestrator response for deleting a non existent service

  Scenario: Delete a non existent service
