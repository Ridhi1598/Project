@orchestrator @tc83 @updateService
Feature: Validate orchestrator response for updating access type for an existing service
  This features validates orchestrator response for updating access type for an existing service
  ...
  Scenario: Update access type for an existing service
    Given I set data values against testcase
