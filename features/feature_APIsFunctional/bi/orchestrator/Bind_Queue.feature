@orchestrator @bindQueue @rmq @postSetup @demo
Feature: Bind request queue to the exchange
  ...
  Scenario: Bind request queue to the default exchange
    ...
    And I set api endpoint "/api/bindings/%2F/e/bi-ctrl/q/tinaa-bi-request-callbacks" for "POST"
    ...
    And Validate response header "location" for "tinaa-bi-request-callbacks/tinaa-bi-request-callbacks"
    ...
    And Validate that "tinaa-bi-request-callbacks" queue "has" "bi-ctrl" exchange as source