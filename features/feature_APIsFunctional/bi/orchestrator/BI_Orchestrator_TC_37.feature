@orchestrator @tc37 @updateService
Feature: Validate orchestrator response for updating incorrect service speed for HS service
  This features validates orchestrator response for updating incorrect service speed for HS service
  ...
  Scenario: Update invalid speed for HS service
    Given I set data values against testcase
