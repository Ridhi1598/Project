@orchestrator @tc106 @createService
Feature: Validate orchestrator response for create HS service request
  This features validates orchestrator response for failed create service request due to invalid device

  Scenario: Create Service request failure due to invalid device: device does not exist
