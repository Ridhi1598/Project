@controller
Feature: Validate controller response for cancelling an update request originating from TINAA
  This features validates controller response for cancelling an update request originating from TINAA
