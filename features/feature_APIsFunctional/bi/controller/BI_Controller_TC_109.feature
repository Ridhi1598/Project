@controller
Feature: Validate controller response in case of create service rollback success
  This features validates controller response in case of create service rollback success

  Scenario: Modify service rollback success: Success
    Given I set BI "controller" url
    And I set data values against test case "109"
