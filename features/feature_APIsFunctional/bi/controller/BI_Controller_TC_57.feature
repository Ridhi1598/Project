@controller
Feature: Validate controller response for executing a request originating from NC
  This features validates controller response for executing a request originating from NC
...
@update
  Scenario: Executing an update request originating from NC
    ...
    And I set data values against test case "57"
