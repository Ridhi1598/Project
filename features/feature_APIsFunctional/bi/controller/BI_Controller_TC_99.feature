@controller @rmq
Feature: Validate controller response for create service request with multiple callbacks
  This features validates controller response for creating a failed service request

  Scenario: Create service request with multiple callbacks
    Given I set BI "controller" url
    And I set data values against test case "99"
