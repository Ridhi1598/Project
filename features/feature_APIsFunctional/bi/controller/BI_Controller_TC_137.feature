...
Feature: Validate controller response for update service
  This features validates controller response for removing ipv4 customer prefixes to an existing service

  Scenario: Remove ipv4 customer prefixes to an existing service and is rejected
    Given I set BI "controller" url
    And I set data values against test case "137"
