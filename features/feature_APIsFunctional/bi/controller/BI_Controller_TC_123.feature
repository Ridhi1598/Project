...
@portalCall
  Scenario: Portal call with result in descending order and search by partial request-state
    Given I set BI "controller" url
    And I set data values against test case "123"
    ...
    And Validate the response is sorted in "descending" order for "partial" match of "request-state"
