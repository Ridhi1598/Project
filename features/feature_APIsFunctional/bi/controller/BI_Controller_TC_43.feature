@controller
Feature: Validate controller response for create service with invalid payload
  This features validates controller response for creating a service with invalid payload

  Scenario: Create service with inconsistent values in payload
    Given I set BI "controller" url
    And I set data values against test case "43"
