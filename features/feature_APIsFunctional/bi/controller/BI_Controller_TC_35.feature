...
Feature: Validate controller response for portal call for historical data
  This features validates controller response for portal call with result in ascending order

@portalCall
  Scenario: Portal call with result in descending order and search by text
    Given I set BI "controller" url
    And I set data values against test case "35"
