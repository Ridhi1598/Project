...
Feature: Validate controller response for activate port
  This features validates controller response for port activation for a terminated service

  Scenario: Activate port for a terminated service
    Given I set BI "controller" url
    And I set data values against test case "12"
