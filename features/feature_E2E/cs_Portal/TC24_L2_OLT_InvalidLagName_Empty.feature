Feature: Negative - Add LAG/TP - Empty Name
  This feature tests the negative scenario of adding OLT LAG/TP with empty name

  Scenario: Negative - Add OLT Topology - Empty lag name  : Success
    Given I set data values against testcase "55"
    ...
    And I verify the error message for empty OLT lag name