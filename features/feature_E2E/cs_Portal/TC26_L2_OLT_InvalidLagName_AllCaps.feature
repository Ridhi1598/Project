Feature: Negative - Add LAG/TP - All Caps Name
  This feature tests the negative scenario of adding OLT LAG/TP with all caps name

  Scenario: Negative - Add OLT Topology - Numeric lag name  : Success
    Given I set data values against testcase "57"
    ...
    And I verify the error message for allcaps OLT lag name