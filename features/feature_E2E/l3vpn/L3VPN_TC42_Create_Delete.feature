@OA2501-1
Feature: TC_42: Create and Delete VRF QPA test
...
Scenario: Create/Update service with valid payload and in valid state
  ...
  When I run "show running-config policy-map WAN_OUT" command and store the device config
  Then I validate the output of "policy-map_WAN_OUT" section at "default-level"
  When I run "show running-config policy-map PARENT_WAN_OUT" command and store the device config
  Then I validate the output of "policy-map_PARENT_WAN_OUT" section at "default-level"
  When I run "show running-config policy-map WAN_IN_VPN2_1_OA" command and store the device config
  Then I validate the output of "policy-map_WAN_IN_VPN2_1_OA" section at "default-level"
  ...
  When I run "show running-config policy-map LAN_IN_VPN2_1_OA" command and store the device config
  Then I validate the output of "policy-map_LAN_IN_VPN2_1_OA" section at "default-level"
  ...
  When I run "show running-config policy-map LAN_OUT_VPN2_1_OA" command and store the device config
  Then I validate the output of "policy-map_LAN_OUT_VPN2_1_OA" section at "default-level"
  ...
  When I run "show running-config class-map LAN_VPN2_1_OA" command and store the device config
  Then I validate the output of "class-map_match-any_LAN_VPN2_1_OA" section at "default-level"
  ...
  When I run "show running-config class-map WAN_VPN2_1_OA" command and store the device config
  Then I validate the output of "class-map_match-any_WAN_VPN2_1_OA" section at "default-level"
...
@deleteService @TC_102
Scenario: Delete the created service for TC_102 which is in valid state
  When I set L3VPN "REST" url
  Then I set api endpoint for testcase "102" for l3vpn
