@OA2501-1
Feature: TC_47: Create and Delete GRF OSPF test
...
@deleteService @TC_107
Scenario: Delete the created service for TC_107 which is in valid state
  When I set L3VPN "REST" url
  Then I set api endpoint for testcase "107" for l3vpn
