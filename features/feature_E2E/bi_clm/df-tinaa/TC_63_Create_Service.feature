@createCLMService @TC63 @df
Feature: TC_63 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_63 - No Accounting Policy: Telus Managed dual-stack BGP Default Full Routes
