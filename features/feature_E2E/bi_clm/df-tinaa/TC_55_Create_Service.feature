@createCLMService @TC55 @df
Feature: TC_55 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_55 - <action> Service - Telus Managed IPv4 BGP Default Full Routes Update Bandwidth and Prefix List
