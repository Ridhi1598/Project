@createCLMService @TC59 @df
Feature: TC_59 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_59 - <action> Service - Telus Managed dual stack BGP Default Full Routes to IPv4 only
