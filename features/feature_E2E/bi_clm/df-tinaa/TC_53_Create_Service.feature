@createCLMService @TC53 @df
Feature: TC_53 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_53 - <action> Service - Telus Managed IPv6 only BGP Default Routes only
