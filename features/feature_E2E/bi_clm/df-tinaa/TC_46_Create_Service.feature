@createCLMService @TC46 @df
Feature: TC_46 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_46 - <action> Service - Customer Managed dual-stack only BGP Full Routes
