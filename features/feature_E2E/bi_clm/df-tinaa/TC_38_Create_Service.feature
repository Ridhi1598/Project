@createCLMService @TC38 @df
Feature: TC_38 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_38 - <action> Service - Telus Managed dual-stack BGP Default Full Routes
