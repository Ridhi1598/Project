@createCLMService @TC78 @pon
Feature: TC_78 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_78 - <action> Service - Provider Managed dual-stack BGP Default Full Routes
