@updateCLMService @TC20 @pon
Feature: TC_20 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_20 - <action> Service - Telus Managed IPv6 only BGP Default Full Routes to Dual Stack
