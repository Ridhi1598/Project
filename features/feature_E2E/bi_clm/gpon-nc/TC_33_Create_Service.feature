@createCLMService @TC333 @pon @prefix
Feature: TC_33 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_33 - <action> Service - BI both IPV4 & IPV6 Customer Managed prefix
