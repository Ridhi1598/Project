@updateCLMService @TC22 @pon
Feature: TC_22 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_22 - <action> Service - Telus Managed dual stack BGP Default Full Routes to IPv6 only
