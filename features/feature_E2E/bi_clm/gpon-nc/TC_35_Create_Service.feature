@createCLMService @TC35 @pon @prefix
Feature: TC_35 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_35 - <action> Service - BI IPV4 Customer Managed IPV6 both prefix
