@createMWRService @TC25 @pon @mwr
Feature: TC_25 Sequence: BI_CLM Add MWR Service
  This feature tests the end to end functionality of service creation and adding mwr

  Scenario Outline: TC_25 - <action> Service - Provider Managed ipv4 BGP Default Routes
