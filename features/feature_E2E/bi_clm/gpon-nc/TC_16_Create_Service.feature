@createCLMService @TC16 @pon
Feature: TC_16 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_16 - <action> Service - Telus Managed IPv6 only BGP Default Routes only
