@createCLMService @TC32 @pon @prefix
Feature: TC_32 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_32 - <action> Service - BI both IPV4 & IPV6 Telus Managed prefix
