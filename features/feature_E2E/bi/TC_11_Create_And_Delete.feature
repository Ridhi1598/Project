@nokia @tc11 @hs
Feature: TC_11 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC11
  ...
  @createUpdateBIService @TC11 @deleteService
  Scenario: Delete the created service for TC_11 which is in valid state
