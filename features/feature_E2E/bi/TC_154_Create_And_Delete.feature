@nokiaGpon @nokia @gpon @tc154 @qinq
Feature: TC_154 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC154
  ...
  @createUpdateBIService @TC154 @deleteService
