@juniper @tc75 @mwr @dsl
Feature: TC_75 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC75
  ...
  @createUpdateBIService @TC75 @deleteService
