@juniperGpon @juniper @gpon @tc149
Feature: TC_149 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC149
  ...
  @createUpdateBIService @TC149 @deleteService
