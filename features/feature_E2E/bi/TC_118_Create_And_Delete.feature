@nokiaGpon @nokia @gpon @mwr @tc118
Feature: TC_118 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC118
  ...
  @createUpdateBIService @TC118 @deleteService
