@nokia @tc174 @autoNegotiate @ignore
Feature: TC_174 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC174
  ...
  @createUpdateBIService @TC174 @deleteService
  Scenario: Delete the created service for TC_174 which is in valid state
