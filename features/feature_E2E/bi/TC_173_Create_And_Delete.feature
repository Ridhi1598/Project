@juniper @tc173 @autoNegotiate @hs
Feature: TC_173 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC173
  ...
  @createUpdateBIService @TC173 @deleteService
  Scenario: Delete the created service for TC_173 which is in valid state
