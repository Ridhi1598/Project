@nokia @tc51 @mwr @dsl @rollback
Feature: TC_51 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC51
  ...
  @createUpdateBIService @TC51 @deleteService
  Scenario: Delete the created service for TC_51 which is in valid state
