@nokiaGpon @nokia @gpon @tc145
Feature: TC_145 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC145
  ...
  @createUpdateBIService @TC145 @deleteService
