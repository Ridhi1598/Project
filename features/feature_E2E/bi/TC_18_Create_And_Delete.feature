@juniper @tc18 @ipv6remove @hs
Feature: TC_18 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC18
  ...
  @createUpdateBIService @TC18 @deleteService
  Scenario: Delete the created service for TC_18 which is in valid state
