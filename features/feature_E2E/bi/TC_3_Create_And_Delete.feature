@juniper @tc3 @dsl
Feature: TC_3 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC3
  ...
  @createUpdateBIService @TC3 @deleteService
  Scenario: Delete the created service for TC_3 which is in valid state
    ...
    And Send HTTP request for BI
    And I validate the controller response as "completed"
    Then I download config files for testcase "87"
    And I validate the generated configurations