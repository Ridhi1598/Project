@nokia @tc15 @dsl
Feature: TC_15 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC15
  ...
  @createUpdateBIService @TC15 @deleteService
  Scenario: Delete the created service for TC_15 which is in valid state
