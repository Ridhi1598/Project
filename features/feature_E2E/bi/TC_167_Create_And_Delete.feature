@nokia @tc167 @nokiaVendor
Feature: TC_167 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC167
  ...
  @createUpdateBIService @TC167 @deleteService
  Scenario: Delete the created service for TC_167 which is in valid state
