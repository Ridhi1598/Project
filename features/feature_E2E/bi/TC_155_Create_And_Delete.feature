@juniperGpon @juniper @gpon @tc155 @qinq @ignore
Feature: TC_155 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC155
  ...
  @createUpdateBIService @TC155 @deleteService
  Scenario: Delete the created service TC_155 which is in valid state
