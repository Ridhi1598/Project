@juniper @tc12 @dsl
Feature: TC_12 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC12
  ...
  @createUpdateBIService @TC12 @deleteService
  Scenario: Delete the created service for TC_12 which is in valid state
