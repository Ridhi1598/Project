@nokia @tc166 @nokiaVendor
Feature: TC_166 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC166
  ...
  @createUpdateBIService @TC166 @deleteService
  Scenario: Delete the created service for TC_166 which is in valid state
