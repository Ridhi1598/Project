@nokiaGpon @nokia @gpon @tc116
Feature: TC_116 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC116
  ...
  @createUpdateBIService @TC116 @deleteService
