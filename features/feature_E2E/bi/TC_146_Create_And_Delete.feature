@juniperGpon @juniper @gpon @tc146
Feature: TC_146 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC146
  ...
  @createUpdateBIService @TC146 @deleteService
