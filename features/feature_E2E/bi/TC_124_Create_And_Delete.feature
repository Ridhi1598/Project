@nokiaGpon @nokia @gpon @tc124
Feature: TC_124 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC124
  ...
  @createUpdateBIService @TC124 @deleteService
