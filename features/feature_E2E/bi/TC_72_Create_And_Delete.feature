@juniper @tc72 @mwr @hs @rollback
Feature: TC_72 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC72
  ...
  @createUpdateBIService @TC69 @deleteService
