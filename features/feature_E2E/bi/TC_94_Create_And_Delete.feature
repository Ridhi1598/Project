@nokiaGpon @nokia @gpon @tc94
Feature: TC_94 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC94
  ...
  @createUpdateBIService @TC94 @deleteService
