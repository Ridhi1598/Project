@juniper @tc78 @dsl
Feature: TC_78 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC78
  ...
  @createUpdateBIService @TC78 @deleteService
  Scenario: Delete the created service for TC_78 which is in valid state
