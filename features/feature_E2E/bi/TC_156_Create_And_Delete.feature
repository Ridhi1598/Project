@nokiaGpon @nokia @gpon @tc156 @qinq
Feature: TC_156 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC156
  ...
  @createUpdateBIService @TC156 @deleteService
  Scenario: Delete the created service TC_156 which is in valid state
