@nokia @tc176 @autoNegotiate @ignore
Feature: TC_176 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC176
  ...
  @createUpdateBIService @TC176 @deleteService
  Scenario: Delete the created service for TC_176 which is in valid state
