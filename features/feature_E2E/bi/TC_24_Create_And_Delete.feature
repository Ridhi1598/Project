@juniper @tc24 @ipv6remove @hs
Feature: TC_24 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC24
  ...
  @createUpdateBIService @TC24 @deleteService
  Scenario: Delete the created service for TC_24 which is in valid state
