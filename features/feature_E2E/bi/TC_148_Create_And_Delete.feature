@nokiaGpon @nokia @gpon @tc148
Feature: TC_148 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC148
  ...
  @createUpdateBIService @TC148 @deleteService
