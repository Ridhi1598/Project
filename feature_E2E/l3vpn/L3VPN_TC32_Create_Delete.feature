@ASR920-6
Feature: TC_32: Create GRF ospf routing
...
@deleteService @TC_92
Scenario:Delete the created service for TC_92 which is in valid state
  When I set L3VPN "REST" url
  Then I set api endpoint for testcase "92" for L3VPN
