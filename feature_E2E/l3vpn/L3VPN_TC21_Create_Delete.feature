@ASR920-6
Feature: TC_21: Create and Delete QPA VRF tests
  ...
  Scenario: Create/Update service with valid payload and in valid state
    ...
    When I query the content of section "policy-map LAN_OUT_VPN2_asr1" at "0" level
    Then I validate the output of "policy-map_LAN_OUT_VPN2_asr1" section
    ...
    When I query the content of section "policy-map WAN_IN_VPN2_asr1" at "0" level
    Then I validate the output of "policy-map_WAN_IN_VPN2_asr1" section
    ...
    When I query the content of section "policy-map LAN_IN_VPN2_asr1" at "0" level
    Then I validate the output of "policy-map_LAN_IN_VPN2_asr1" section
...
#    Then I validate the output of "class-map_match-any_QOS_GROUP_AF2" section
    ...
    When I query the content of section "class-map match-any WAN_VPN2_asr1" at "0" level
    Then I validate the output of "class-map_match-any_WAN_VPN2_asr1" section
    And I close the SSH connection

  @deleteService @TC_81
  Scenario: Delete the created service for TC_81 which is in valid state
    When I set L3VPN "REST" url
    Then I set api endpoint for testcase "81" for l3vpn
