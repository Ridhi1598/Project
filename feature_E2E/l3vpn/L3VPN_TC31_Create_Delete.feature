@ASR920-6
Feature: TC_31: Create VRF rip routing
  ...
  Scenario: Create/Update service with valid payload and in valid state
    ...
    When I query the content of section "vrf definition TEST_VRF_RIP" at "0" level
    Then I validate the output of "vrf_definition_TEST_VRF_RIP" section
  ...
  @deleteService @TC_91
  Scenario:Delete the created service for TC_91 which is in valid state
    When I set L3VPN "REST" url
    Then I set api endpoint for testcase "91" for L3VPN
