@nokia @tc170 @autoNegotiate @hs
Feature: TC_170 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC170
  ...
  @createUpdateBIService @TC170 @deleteService
  Scenario: Delete the created service for TC_170 which is in valid state
