@nokia @tc60 @dsl
Feature: TC_60 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC60
  ...
  @createUpdateBIService @TC60 @deleteService
  Scenario: Delete the created service for TC_60 which is in valid state
