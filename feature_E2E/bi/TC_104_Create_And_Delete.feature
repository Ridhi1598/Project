@juniperGpon @juniper @gpon @tc104
Feature: TC_104 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC104
  ...
  @createUpdateBIService @TC104 @deleteService
  Scenario: Delete the created service which is in valid state
    ...
    And Send HTTP request for BI
    And I validate the controller response as "completed"
    Then I download config files for testcase "106"
    And I validate the generated configurations