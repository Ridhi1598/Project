@juniperGpon @juniper @gpon @tc102
Feature: TC_102 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC102
  ...
  @createUpdateBIService @TC102 @deleteService
