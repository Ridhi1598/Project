@nokia @tc57 @dsl
Feature: TC_57 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC57
  ...
  @createUpdateBIService @TC57 @deleteService
  Scenario: Delete the created service for TC_57 which is in valid state
