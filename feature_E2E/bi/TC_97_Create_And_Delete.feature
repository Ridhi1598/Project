@nokiaGpon @nokia @gpon @tc97
Feature: TC_97 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC97
  ...
  @createUpdateBIService @TC97 @deleteService
