@nokia @tc21 @hs
Feature: TC_21 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC21
...
#      |186           |
  ...
  @createUpdateBIService @TC21 @deleteService
  Scenario: Delete the created service for TC_21 which is in valid state
