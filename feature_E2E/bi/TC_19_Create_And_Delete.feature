@nokia @tc19 @hs
Feature: TC_19 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC19
  ...
  @createUpdateBIService @TC19 @deleteService
  Scenario: Delete the created service for TC_19 which is in valid state
