@nokiaGpon @nokia @gpon @tc150 @qinq
Feature: TC_150 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC150
  ...
  @createUpdateBIService @TC150 @deleteService
