@juniper @tc67 @dsl
Feature: TC_67 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC67
  ...
  @createUpdateBIService @TC67 @deleteService
  Scenario: Delete the created service for TC_67 which is in valid state
