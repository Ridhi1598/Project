@juniperGpon @juniper @gpon @tc112
Feature: TC_112 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC112
  ...
  @createUpdateBIService @TC112 @deleteService
