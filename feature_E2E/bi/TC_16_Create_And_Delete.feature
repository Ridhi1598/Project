...
Feature: TC_16 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateBIService @TC16 @deleteService
  Scenario: Delete the created service for TC_16which is in valid state
