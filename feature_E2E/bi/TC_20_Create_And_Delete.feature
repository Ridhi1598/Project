@juniper @tc20 @ipv6remove @hs
Feature: TC_20 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC20
  ...
  @createUpdateBIService @TC20 @deleteService
  Scenario: Delete the created service for TC_20 which is in valid state
