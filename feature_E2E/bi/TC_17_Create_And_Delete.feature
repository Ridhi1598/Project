@juniper @tc17 @dsl
Feature: TC_17 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC17
  ...
  @createUpdateBIService @TC17 @deleteService
  Scenario: Delete the created service for TC_17 which is in valid state
