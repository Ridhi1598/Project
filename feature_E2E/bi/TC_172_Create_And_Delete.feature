@juniper @tc172 @autoNegotiate @ignore
Feature: TC_172 Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC172
  ...
  @createUpdateBIService @TC172 @deleteService
  Scenario: Delete the created service for TC_172 which is in valid state
