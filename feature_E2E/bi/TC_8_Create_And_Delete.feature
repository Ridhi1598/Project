@nokia @tc8 @ipv6remove @dsl
Feature: TC_8 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC8
  ...
  @createUpdateBIService @TC8 @deleteService
  Scenario: Delete the created service for TC_8 which is in valid state
