@nokia @tc54 @mwr @hs
Feature: TC_54 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC54
  ...
  @createUpdateBIService @TC54 @deleteService
  Scenario: Delete the created service for TC_54 which is in valid state
