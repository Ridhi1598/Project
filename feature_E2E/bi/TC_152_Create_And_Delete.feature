@juniperGpon @juniper @gpon @tc152 @qinq @ignore
Feature: TC_152 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC152
  ...
  @createUpdateBIService @TC152 @deleteService
