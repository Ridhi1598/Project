@nokiaGpon @nokia @gpon @tc114
Feature: TC_114 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC114
  ...
  @createUpdateBIService @TC114 @deleteService
