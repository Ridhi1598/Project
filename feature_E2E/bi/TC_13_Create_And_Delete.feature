@juniper @tc13 @hs @RE
Feature: TC_13 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC13
...
#      |221           |
  ...
  @createUpdateBIService @TC13 @deleteService
  Scenario: Delete the created service for TC_13 which is in valid state
