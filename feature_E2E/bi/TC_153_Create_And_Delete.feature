@juniperGpon @juniper @gpon @tc153 @qinq @ignore
Feature: TC_153 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC153
  ...
  @createUpdateBIService @TC153 @deleteService
