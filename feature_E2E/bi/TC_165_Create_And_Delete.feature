@nokia @tc165 @nokiaVendor
Feature: TC_165 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC165
  ...
  @createUpdateBIService @TC165 @deleteService
  Scenario: Delete the created service for TC_165 which is in valid state
