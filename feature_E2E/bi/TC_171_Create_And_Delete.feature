@nokia @tc171 @autoNegotiate @ignore
Feature: TC_171 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC171
  ...
  @createUpdateBIService @TC171 @deleteService
  Scenario: Delete the created service for TC_171 which is in valid state
