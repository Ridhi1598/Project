@nokia @tc23 @hs
Feature: TC_23 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC23
  ...
  @createUpdateBIService @TC23 @deleteService
  Scenario: Delete the created service for TC_23 which is in valid state
