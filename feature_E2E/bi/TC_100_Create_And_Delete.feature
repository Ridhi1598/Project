@juniperGpon @juniper @gpon @tc100
Feature: TC_100 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC100
  ...
  @createUpdateBIService @TC100 @deleteService
