@nokiaGpon @nokia @gpon @tc147
Feature: TC_147 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC147
  ...
  @createUpdateBIService @TC147 @deleteService
