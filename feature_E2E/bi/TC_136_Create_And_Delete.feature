@juniperGpon @juniper @gpon @tc136
Feature: TC_136 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC136
  ...
  @createUpdateBIService @TC136 @deleteService
