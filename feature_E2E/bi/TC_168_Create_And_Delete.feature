@nokia @tc168 @nokiaVendor @hs
Feature: TC_168 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC168
  ...
  @createUpdateBIService @TC168 @deleteService
  Scenario: Delete the created service for TC_168 which is in valid state
