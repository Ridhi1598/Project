@nokiaGpon @nokia @gpon @tc151 @qinq
Feature: TC_151 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC151
  ...
  @createUpdateBIService @TC151 @deleteService
