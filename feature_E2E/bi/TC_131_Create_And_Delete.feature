@nokiaGpon @nokia @gpon @mwr @tc131
Feature: TC_131 sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC131
  ...
  @createUpdateBIService @TC131 @deleteService
