@nokia @tc9 @ipv6remove @dsl
Feature: TC_9 Sequence: Create, Update and Delete BI Service
  ...
  @createUpdateDeleteBIService @TC9
  ...
  @createUpdateBIService @TC9 @deleteService
  Scenario: Delete the created service for TC_9 which is in valid state
