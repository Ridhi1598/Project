@createCLMService @TC58 @df
Feature: TC_58 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_58 - <action> Service - Telus Managed IPv6 only BGP Default Full Routes to Dual Stack
