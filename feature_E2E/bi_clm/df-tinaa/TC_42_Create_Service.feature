@createCLMService @TC42 @df
Feature: TC_42 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_42 - <action> Service - Customer Managed IPv4 BGP Default Full Routes
