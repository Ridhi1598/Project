@createCLMService @TC56 @df
Feature: TC_56 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_56 - <action> Service - Telus Managed IPv4 only BGP Default Full Routes to Dual Stack
