@createCLMService @TC47 @df
Feature: TC_47 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_47 - <action> Service - Customer Managed dual-stack only BGP Default Full Routes
