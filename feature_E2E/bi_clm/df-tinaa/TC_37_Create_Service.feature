@createCLMService @TC37 @df
Feature: TC_37 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_37 - <action> Service - Telus Managed IPv6 only BGP Default Full Routes
