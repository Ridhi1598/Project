@createCLMService @TC9 @pon
Feature: TC_9 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_9 - <action> Service - Customer Managed dual-stack only BGP Default Routes
