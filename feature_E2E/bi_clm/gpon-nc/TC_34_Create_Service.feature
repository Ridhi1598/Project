@createCLMService @TC34 @pon @prefix
Feature: TC_34 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_34 - <action> Service - BI IPV4 Telus Managed IPV6 both prefix
