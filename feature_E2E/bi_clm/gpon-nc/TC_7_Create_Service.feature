@createCLMService @TC7 @pon @test
Feature: TC_7 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_7 - <action> Service - Customer Managed IPv6 only BGP Default Full Routes
