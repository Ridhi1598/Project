@createCLMService @TC8 @pon
Feature: TC_8 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_8 - <action> Service - Customer Managed dual-stack only BGP Default Full Routes
