@createMWRService @TC24 @pon @mwr
Feature: TC_24 Sequence: BI_CLM Add MWR Service
  This feature tests the end to end functionality of service creation and adding mwr

  Scenario Outline: TC_24 - <action> Service - Provider Managed ipv4 BGP Default Routes
