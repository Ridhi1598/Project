@updateCLMService @TC21 @pon
Feature: TC_21 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_21 - <action> Service - Telus Managed dual stack BGP Default Full Routes to IPv4 only
