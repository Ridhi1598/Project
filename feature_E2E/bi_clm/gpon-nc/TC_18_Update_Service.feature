@updateCLMService @TC18 @pon
Feature: TC_18 Sequence: BI_CLM Update Service
  This feature tests the end to end functionality of update, display and execute request

  Scenario Outline: TC_18 - <action> Service - Telus Managed IPv4 BGP Default Full Routes - Update Bandwidth and Prefix List
