@createCLMService @TC6 @pon @test
Feature: TC_6 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_6 - <action> Service - Customer Managed IPv4 BGP Default Full Routes
