@createCLMService @TC86 @pon
Feature: TC_86 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_86 - <action> Service - Provider Managed dual-stack BGP Default Full Routes
