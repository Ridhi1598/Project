@createCLMService @TC88 @pon
Feature: TC_88 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation and deletion

  Scenario Outline: TC_88 - <action> Service - Provider Managed dual-stack BGP Default Full Routes
