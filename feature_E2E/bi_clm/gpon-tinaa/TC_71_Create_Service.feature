@createCLMService @TC71 @pon
Feature: TC_71 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_71 - <action> Service - Provider Managed IPv4 BGP Default Full Routes
