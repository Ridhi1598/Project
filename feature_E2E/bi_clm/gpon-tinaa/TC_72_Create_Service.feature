@createCLMService @TC72 @pon
Feature: TC_72 Sequence: BI_CLM Create Service
  This feature tests the end to end functionality of service creation creation and deletion

  Scenario Outline: TC_72 - <action> Service - Provider Managed IPv6 only BGP Default Full Routes
