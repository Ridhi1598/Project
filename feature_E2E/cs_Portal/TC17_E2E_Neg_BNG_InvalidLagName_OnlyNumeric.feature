Feature: Negative - Add LAG/TP - Numeric Only Name
  This feature tests the negative scenario of adding LAG/TP with numeric only name

  Scenario: Add BNG Topology : Success
    Given I set data values against testcase "48"
    ...
    And I verify the error message for numeric lag name